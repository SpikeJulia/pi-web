...
/**
 * Drag-over affordance layered over the chat surface. Spec §"Chat window
 * drop zone" requires the "Drop to attach" text alongside the existing
 * highlight + ripple animation. Extracted so the markup can be unit-tested
 * in SSR without dragging the entire chat state machine in.
 */
export function DropToAttachOverlay() {
  return (
    <div
      data-drop-to-attach="true"
    ...
    >
      ...
      <div className="pointer-events-none relative z-10 flex flex-col items-center gap-3">
        <svg
          width="180" height="180" viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <span
          data-drop-to-attach-label="true"
          style={{
            color: "var(--accent)",
